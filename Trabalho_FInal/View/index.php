            ...
            $.ajax({
                ...
                success: function(responseData) {
                    ...
                    for (i = 0; resultado.length; i++) {
                        $novotr = $("<tr></tr>");
                        $caminhotd = $("<br><td><img  style='max-width:128px;max-height:150px;width: auto;height: auto;margin-right:10px!important; border-radius:20px' src='http://anakordelos.com/wp-content/uploads/2016/05/top-05-filmes-favoritos-da-vida.jpg'></td>");
...
<body>
    ...
    <div class="container" id="listaFilme">
        <div class="col-xs-12 col-sm-6">
            <h1 style="margin:20px 5px ;color:white">Filmes</h1>
        </div>
        <center>
