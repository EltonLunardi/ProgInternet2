...
<html lang="en">
    <head>
        <title>MyCineList - Minha Lista</title>
        <meta charset="UTF-8">
                ...
                $.ajax({
                    ...
                    success: function(responseData){
                        ...
                        for(i = 0; resultado.length; i++) {
                            $novotr = $("<tr></tr>");
                            $caminhotd = $("<br><td><img  style='max-width:128px;max-height:150px;width: auto;height: auto;margin-right:10px!important;border-radius:20px' src='https://images.mod-fashions.com/img/lists/6/screen-rantquots-top-5-favorite-movies-2016.jpg'></td>");
                            ...
                            $sinopsetd = $("<td style='width: 300px;margin-left:10px!important'>" + resultado[i].sinopse + "</td>");
    ...
    <body>
        ...
        <div class="container" id="listaFilme">
            <div class="col-xs-12 col-sm-6"><h1 style="margin:20px 5px;color:white">Minha Lista</h1></div>
            <center>
                <table id="tabelaFilme" class="table" style="color:white">
                    <thead>
                        <tr>
                        <th>Imagem</th>
                        <th>Titulo</th>
